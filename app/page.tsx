...
export default function Home() {
  return (
    <main id="top" className="font-sans">
      {/* Nav + Motion live OUTSIDE the smooth wrapper: the nav is fixed, and
          ScrollSmoother transforms #smooth-content (which would break fixed). */}
      <Nav />
      <Motion />
          ...
          <section className="relative overflow-hidden py-28">
            <div className="mx-auto grid max-w-6xl items-center gap-14 px-6 sm:px-10 md:grid-cols-2">
              ...
              <div>
                ...
                <a href="#work" className="reveal group mt-8 inline-flex items-center gap-3 text-sm uppercase tracking-[0.18em] text-ink">
                  <span className="border-b border-ink/40 pb-1 transition-colors group-hover:border-ink">See the work</span>
